...
from user_service.app.crud import user as crud_user
from user_service.app.dependencies import user_by_id
from user_service.app.schemas import User, UserCreate, UserUpdate, UserUpdatePartial
